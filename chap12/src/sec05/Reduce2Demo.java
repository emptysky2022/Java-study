...
public class Reduce2Demo {
	public static void main(String[] args) {
		...
		double sumOfPapulation = s2.filter(n -> n.getGdpRank() <= 20).mapToDouble(n -> n.getPopulation()).reduce(0.0,
				(n1, n2) -> n1 + n2);
		System.out.println("리스트에서 GDP가 20위 이내의 나라의 인구 총합은 " + sumOfPapulation + "백만명이다.");
