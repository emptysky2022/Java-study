...
public class PartitioningDemo {
	public static void main(String[] args) {
		...
		Map<Boolean, Long> m2 = sn
				.collect(Collectors.partitioningBy(p -> p.getType() == Type.LAND, Collectors.counting()));
		System.out.println(m2);

		sn = Nation.nations.stream().limit(4);
		Map<Boolean, String> m3 = sn.collect(Collectors.partitioningBy(p -> p.getType() == Type.LAND,
